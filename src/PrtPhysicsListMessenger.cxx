...
PrtPhysicsListMessenger::PrtPhysicsListMessenger(PrtPhysicsList *pPhys)
  ...
  fCerenkovCmd = new G4UIcmdWithAnInteger("/Prt/phys/cerenkovMaxPhotons", this);
...
void PrtPhysicsListMessenger::SetNewValue(G4UIcommand *command,
  ...
  if (command == fCerenkovCmd) {
    fPhysicsList->SetNbOfPhotonsCerenkov(
        fCerenkovCmd->GetNewIntValue(newValue));
  }
}
